...
If you aren't already logged in, the login process will begin. The login process will vary depending on whether you have a web browser on the system where you are running `cfde-submit`.
